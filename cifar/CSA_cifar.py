...
# 记录日志
path_log = '../log/Lenet_CIFAR_CSA.log'
...
def run_training():
    ...
    #             
            ...
            if correct/len(test_loader.dataset) > correst_adv_best:
                ...
                if NORMALIZE:
                    path_model_save = '../model/LeNet_CIFAR_adv_cost_sensitive_' + str(i_label) + '_e' + str(epsilon) +'.pt'
                else:
                    path_model_save = '../model/LeNet_CIFAR_unnormalized_adv_cost_sensitive_' + str(i_label) + '_e' + str(epsilon) +'.pt'
