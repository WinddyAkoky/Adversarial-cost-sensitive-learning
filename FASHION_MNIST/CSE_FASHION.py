...
# 记录日志
path_log = '../log/Lenet_FASHION_MNIST_CSE.log'
...
def run_training():
    ...
    for i_label in range(10):
        ...
        criterion_CSE = Loss_CSE(model_cost_sensitive, a=0.1, b=5, c=0.1)
    ...
    #             
            ...
            if correct/len(test_loader.dataset) > correst_adv_best:
                ...
                # 保存模型
                if NORMALIZE:
                    model_save_path = '../model/LeNet_FASHION_MNIST_cost_sensitive_extension_' + str(i_label) +'.pt'
                else:
                    model_save_path = '../model/LeNet_FASHION_MNIST_unnormalized_cost_sensitive_extension_' + str(i_label) +'.pt'
